...
public class ExcelUtils {
	 ...
	 * 导出用户列表
	 */
	public static void exportUserExcel(List<User> userList,ServletOutputStream servletOutputStream){
		try {
			//1、创建工作簿
			...
			sheet.addMergedRegion(cellRangeAddress);//加载合并单元格对象
			sheet.setDefaultColumnWidth(25);//设置单元格默认宽度
